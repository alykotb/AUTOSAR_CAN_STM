...
#define EXT_MASK 0x80000000U



#define STD_ID_SHIFT  16U
#define STD_ID_POS  5U
#define EXT_ID_POS  3U
#define Controller0_Filterbanks_start 0U
#define Controller1_Filterbanks_start 0x4U
...
#define confirmed 0U
#define un_confirmed 1U

#define Maximum_Data_Size 8U
...
typedef  bool EcuM_WakeupSourceType;

/*Implementation specificTypes*/
...
//typedef struct HTH_Mailboxes
//      {
//		   uint8_t   Starting_Mailbox;
//		   uint8_t   Busy_Mailboxes_Num;
//      }HTH_Mailboxes;

typedef struct Register_Baudrate_paramters
  {
 	   uint8_t Prescaler;
 	   uint32_t SyncJumpWidth;
 	   uint32_t TimeSeg1;
 	   uint32_t TimeSeg2;
  }Register_Baudrate_paramters;
/* End of implementation specificTypes*/
...
typedef struct Can_HwType
   ...
   /*  typedef enum CanProcessing
     ...
     typedef struct CanConfigSet
     {
          ...
          */
         CanController CanController[NUM_OF_ACTIVE_CAN_CONTROLLERS];
         /*
           This container contains the configuration (parameters) of CAN Hardware Objects.
          */
